...
var knowledge = {
	...
	rules:[
		...
		iftrue:'final(36);final(61);',
		iffalse:''},
		{rid:361,cond: 'q(15) == "Manchas secas"',
		iftrue:'final(60);final(37);',
		iffalse:''},
		{rid:362,cond: 'q(15) == "No hay manchas"',
		iftrue:'final(60);final(61);',
		iffalse:''},
		////////////////////////////////////////////////// HIPOTESIS 13 //////////////////////////////////////////////
		...
		iftrue:'final(37);final(60);',
		iffalse:''},
		{rid:36,cond: 'q(16) == "Bolitas oscuras"',
		iftrue:'final(61);final(36);',
		iffalse:''},
		{rid:382,cond: 'q(16) == "No hay manchas"',
		iftrue:'final(60);final(61);',
		iffalse:''},
		////////////////////////////////////////////////// HIPOTESIS 14 //////////////////////////////////////////////
