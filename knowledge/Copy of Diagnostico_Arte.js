...
var knowledge = {
	...
	questions:[
		...
		{qid:7,
			...
			info:[
				...
				'Se lija con dificultad',]},
		{qid:10,
			qtext:'¿Tiene el cuadro refuerzos por detrás?',
			qdesc:
			'<p>Puede que la causa sea que se han usado refuerzos para impedir el movimiento.</p>' +
		...
		{qid:15,
			...
			qdesc:
			'<p>Puede que la causa sea que los hongos xilófagos hayan atacado el soporte.</p>' +
		...
		{qid:152,
			...
			info:[
				...
				'No',]},
		{qid:17,
			qtext:'¿El soporte está gelatinoso?',
			qdesc:
			'<p>Puede que la causa sea que el soporte haya sido afectado por pudrición blanda.</p>' +
			'<p>Compruebe el soporte.</p>',
			qtype:'selection',
			info:[
				'Si',
				'No',]},
		{qid:19,
			qtext:'¿Tiene el soporte agujeros limpios y de forma circular o elíptica?',
			qdesc:
			'<p>Puede que la causa sea que el soporte haya sido atacado por insectos.</p>' +
			'<p>Compruebe el soporte.</p>',
			qtype:'selection',
			info:[
				'Si',
	...
	rules:[
		...
		iffalse:''},
		{rid:33,cond: 'q(15) == "No"',
		iftrue:'set(62);set(63);',
		iffalse:''},
		{rid:34,cond: 'q(152) == "Si"',
		iftrue:'final(39);set(62);',
		iffalse:''},
		{rid:35,cond: 'q(152) == "No"',
		iftrue:'final(38);set(63);',
		iffalse:''},
		////////////////////////////////////////////////// BLOQUE HIPÓTESIS 17 ////////////////////////////////////////
		{rid:36,cond: 'f(17)',
		iftrue:'ask(17);',
